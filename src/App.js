...
import { 
  ...
  Heart, Moon, Sun, Zap, BarChart3, Clock, Filter, Image as ImageIcon
} from 'lucide-react';
           ...
           <div className="space-y-40 animate-in fade-in duration-1000">
              ...
              <section className={`rounded-[4rem] p-24 flex items-center gap-24 relative overflow-hidden shadow-sm ${darkMode ? 'bg-[#2A2825]' : 'bg-white border border-[#E8E2D9]'}`}>
                 ...
                 <div className="flex-1 space-y-12 relative z-10">
                    ...
                    <h2 className="text-8xl font-black leading-[0.9] tracking-tighter relative uppercase">{profile.shopName}</h2>
                 ...
                 <div className="flex-1 relative z-10 space-y-8">
                    ...
                    <div className="w-full h-[300px] bg-[#F3EFE9] rounded-[3rem] border border-dashed border-[#E8E2D9] flex flex-col items-center justify-center text-[#A68966]">
                       <ImageIcon size={64} className="opacity-20 mb-4" />
                       <span className="text-[10px] font-black uppercase tracking-widest opacity-40">Banner Visual Toko</span>
                    </div>
                    <div className="grid grid-cols-2 gap-8">
                      <div className={`p-10 rounded-[3.5rem] shadow-xl ${darkMode ? 'bg-white/5 border border-white/5' : 'bg-[#FDFBF7] border border-gray-100'}`}>
                         <BarChart3 size={32} className="text-[#A68966] mb-6"/>
                         <h4 className="text-xl font-black mb-2 tracking-tighter">Kualitas Premium</h4>
                         <p className="text-xs opacity-50 font-medium leading-relaxed">Material pilihan terbaik pengrajin lokal.</p>
                      </div>
                      <div className={`p-10 rounded-[3.5rem] shadow-xl ${darkMode ? 'bg-white/5 border border-white/5' : 'bg-[#FDFBF7] border border-gray-100'}`}>
                         <Clock size={32} className="text-[#A68966] mb-6"/>
                         <h4 className="text-xl font-black mb-2 tracking-tighter">Produksi Etis</h4>
                         <p className="text-xs opacity-50 font-medium leading-relaxed">Proses produksi ramah lingkungan.</p>
                      </div>
                    </div>
                 </div>
              </section>
              ...
              <section id="catalog" className="scroll-mt-24 space-y-16">
                 <div className="flex justify-between items-end border-b border-gray-200 pb-16">
                    <div>
                       ...
                       <p className="text-[#A68966] font-black uppercase tracking-[0.4em] text-xs mt-4">Koleksi Terbaru {profile.shopName}</p>
                    </div>
                    <div className="flex items-center gap-4">
                 ...
                 {isLoading ? (
                    <div className="py-40 flex flex-col items-center justify-center space-y-6 opacity-30">
                       ...
                       <p className="font-black uppercase tracking-widest text-xs">Memuat Katalog...</p>
                    </div>
                 ) : filteredProducts.length === 0 ? (
                    <div className="py-40 flex flex-col items-center justify-center space-y-6 text-center bg-white/50 rounded-[4rem] border border-dashed border-gray-200">
                       <ShoppingBag size={80} className="text-[#A68966] opacity-10" />
                       <div>
                         <p className="text-2xl font-black text-[#4A443F] mb-2">Produk Belum Tersedia</p>
                         <p className="text-sm opacity-50 max-w-sm mx-auto">Admin belum mengunggah produk di kategori ini. Silakan tambahkan produk melalui Dashboard Admin.</p>
                       </div>
                       {isLoggedIn && <button onClick={() => {setView('admin'); setAdminSection('products')}} className="text-[#A68966] font-black underline uppercase text-xs tracking-widest mt-4">Tambah Produk Sekarang</button>}
                    </div>
                 ) : (
              ...
              <section className="bg-[#4A443F] rounded-[5rem] p-32 text-white relative overflow-hidden">
                 <div className="max-w-4xl mx-auto text-center space-y-20 relative z-10">
                    ...
                    {testimonials.length === 0 ? (
                      <div className="opacity-20 py-10">
                        <MessageSquare size={64} className="mx-auto mb-4" />
                        <p className="font-black uppercase tracking-widest text-xs">Belum Ada Ulasan</p>
                      </div>
                    ) : (
           ...
           <div className="flex gap-16 animate-in slide-in-from-bottom-10 duration-1000">
              <aside className="w-80 shrink-0 space-y-4">
                 <div className="p-10 bg-[#A68966] text-white rounded-[3rem] shadow-xl">
                    ...
                    <p className="text-[10px] font-black uppercase opacity-60 mt-2 tracking-widest">Panel Kendali</p>
                 </div>
              ...
              <div className={`flex-1 p-16 rounded-[4rem] shadow-sm border ${darkMode ? 'bg-[#2A2825] border-white/5' : 'bg-white border-gray-100'} min-h-screen`}>
                    ...
                    <div className="space-y-16 animate-in fade-in duration-500">
                       ...
                       <div className="grid grid-cols-3 gap-10">
                          <div className="p-10 rounded-[3rem] bg-[#FDFBF7] dark:bg-white/5 border border-gray-100 dark:border-white/5 relative group">
                             ...
                             <p className="text-xs font-bold opacity-30 mt-4 uppercase">Unit Produk Aktif</p>
                          </div>
                       </div>
                       <div className="p-12 border-2 border-dashed border-gray-200 rounded-[3rem] text-center space-y-4">
                          <PlusCircle size={48} className="mx-auto text-[#A68966] opacity-30" />
                          <p className="font-black text-[#4A443F]">Siap menambah koleksi baru?</p>
                          <button onClick={() => setAdminSection('products')} className="bg-[#4A443F] text-white px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-widest shadow-lg">Kelola Produk</button>
                       </div>
                    </div>
                 )}
                 ...
                 {adminSection === 'products' && (
                   <div className="space-y-12 animate-in fade-in duration-500">
                      <div className="flex justify-between items-center border-b pb-10">
                         <h3 className="text-4xl font-black tracking-tighter">Manajemen Katalog</h3>
                      ...
                      <div className="grid grid-cols-1 gap-4">
                         {products.length === 0 ? (
                            <div className="py-20 text-center opacity-30">Belum ada produk. Klik "Tambah Baru".</div>
                         ) : (
                           products.map(p => (
                            <div key={p.id} className="p-8 rounded-[3rem] bg-[#FDFBF7] dark:bg-white/5 border border-transparent hover:border-[#A68966] transition-all flex items-center gap-10">
                               ...
                               <div className="flex-1">
                                  ...
                                  <div className="flex items-center gap-4 mt-2">
                                     ...
                                     <span className="bg-white dark:bg-black/20 px-3 py-1 rounded-lg text-[10px] font-black border border-gray-100 uppercase">{p.category}</span>
                                  </div>
                               </div>
                               <div className="flex gap-4">
                                  <button onClick={() => setEditObj(p)} className="p-4 text-blue-500 bg-white border rounded-2xl shadow-sm hover:scale-105 transition-transform"><Edit3 size={20}/></button>
                                  <button onClick={() => handleDeleteProduct(p.id)} className="p-4 text-red-400 bg-white border rounded-2xl shadow-sm hover:scale-105 transition-transform"><Trash2 size={20}/></button>
                               </div>
                            </div>
                           ))
                         )}
                 ...
                 {adminSection === 'categories' && (
                  <div className="space-y-12">
                    ...
                    <div className="flex gap-6 p-10 bg-[#FDFBF7] dark:bg-white/5 rounded-[3rem] border border-gray-100">
                      <input id="newCat" placeholder="Kategori baru..." className="flex-1 p-6 rounded-[2rem] border outline-none font-bold bg-white dark:bg-black/20" />
                      <button onClick={() => {
                    ...
                    <div className="grid grid-cols-3 gap-6">
                      {categories.map((c, i) => i !== 0 && (
                        <div key={i} className="flex items-center justify-between p-8 bg-white dark:bg-white/5 rounded-[2.5rem] border border-gray-100">
                          <span className="font-black text-sm">{c}</span>
                          <button onClick={() => setCategories(categories.filter(cat => cat !== c))} className="text-red-200 hover:text-red-500"><X size={20}/></button>
                        </div>
                      ))}
                    </div>
                  </div>
                 ...
                 {adminSection === 'testimonials' && (
                  <div className="space-y-12">
                    <h3 className="text-4xl font-black tracking-tighter">Kelola Ulasan</h3>
                    <div className="p-16 bg-[#FDFBF7] dark:bg-white/5 rounded-[4rem] border-2 border-dashed border-gray-200 space-y-10">
                      <div className="max-w-xl mx-auto space-y-6">
                        <input id="tName" placeholder="Nama Pelanggan" className="w-full p-6 rounded-[2rem] border bg-white dark:bg-black/20 font-bold" />
                        <textarea id="tText" placeholder="Pesan Ulasan..." className="w-full p-8 rounded-[2.5rem] border bg-white dark:bg-black/20 font-medium resize-none" rows="4" />
                        <button onClick={() => {
                          ...
                          }} className="bg-[#A68966] text-white py-7 rounded-[2.5rem] font-black w-full shadow-xl">Kirim Ulasan</button>
                      </div>
                    </div>
                  </div>
                 )}
                   ...
                   <div className="fixed inset-0 z-[250] flex items-center justify-center p-10 bg-black/60 backdrop-blur-md">
                      <div className={`${darkMode ? 'bg-[#2A2825]' : 'bg-white'} p-16 rounded-[4rem] w-full max-w-3xl shadow-2xl max-h-[90vh] overflow-y-auto`}>
                         <div className="flex justify-between items-center mb-12 border-b pb-8">
                            <h4 className="text-3xl font-black tracking-tighter">Editor Katalog</h4>
                         ...
                         <div className="grid grid-cols-2 gap-8">
                            ...
                            <div className="col-span-2 space-y-2">
                               <label className="text-[10px] font-black uppercase opacity-40 ml-4 tracking-widest">Foto Produk (Cloud)</label>
                               <div className="p-10 border-2 border-dashed border-gray-200 rounded-[2rem] flex flex-col items-center">
                                  {isUploading ? <Loader2 className="animate-spin text-[#A68966]" size={40}/> : editObj.image ? (
                                    <div className="flex items-center gap-6"><img src={editObj.image} className="w-24 h-24 rounded-2xl object-cover shadow-lg" alt="" /><button onClick={()=>setEditObj({...editObj, image:null})} className="text-xs font-black text-red-500 underline uppercase tracking-widest">Ganti</button></div>
                                  ) : (
                                    <label className="cursor-pointer flex flex-col items-center">
                                       <Upload size={32} className="opacity-20 mb-2"/>
                                       <span className="text-sm font-black opacity-40">Pilih File Gambar</span>
                            ...
                            <div className="space-y-2">
                               <label className="text-[10px] font-black uppercase opacity-40 ml-4 tracking-widest">Stok Sedia</label>
                            ...
                            <div className="col-span-2 space-y-2">
                               <label className="text-[10px] font-black uppercase opacity-40 ml-4 tracking-widest">Kategori</label>
                               <select className="w-full p-6 rounded-[2rem] border bg-[#FDFBF7] dark:bg-white/5 outline-none font-black" value={editObj.category} onChange={e=>setEditObj({...editObj, category: e.target.value})}>
                         ...
                         <div className="flex gap-4 mt-12">
                            <button onClick={() => saveProduct(editObj)} className="flex-1 py-8 rounded-[2.5rem] bg-[#4A443F] text-white font-black text-xl hover:bg-black shadow-xl" disabled={isUploading}><Save size={24} className="inline mr-2"/> Simpan Katalog</button>
                 ...
                 {adminSection === 'settings' && (
                    <div className="space-y-16">
                       <div className="flex justify-between items-center border-b pb-10">
                          <h3 className="text-4xl font-black tracking-tighter">Identitas Toko</h3>
                          <button onClick={saveProfile} className="bg-[#A68966] text-white px-10 py-5 rounded-[2rem] font-black shadow-xl"><Save size={24} className="inline mr-2"/> Simpan Profil</button>
                       </div>
                       <div className="grid grid-cols-2 gap-10">
                          <div className="space-y-3 col-span-2">
                             <label className="text-[10px] font-black uppercase opacity-40 ml-4 tracking-widest">Nama Toko UMKM</label>
                             <input className="w-full p-8 rounded-[2.5rem] border bg-[#FDFBF7] dark:bg-white/5 outline-none font-black text-2xl uppercase tracking-tighter" value={profile.shopName} onChange={e=>setProfile({...profile, shopName: e.target.value})} />
                          </div>
                          <div className="space-y-3">
                          ...
                          <div className="space-y-3">
                             <label className="text-[10px] font-black uppercase opacity-40 ml-4 tracking-widest">Alamat / Lokasi</label>
                             <input className="w-full p-8 rounded-[2.5rem] border bg-[#FDFBF7] dark:bg-white/5 outline-none font-bold" value={profile.address} onChange={e=>setProfile({...profile, address: e.target.value})} />
                          </div>
                          <div className="space-y-3 col-span-2">
                             <label className="text-[10px] font-black uppercase opacity-40 ml-4 tracking-widest">Deskripsi Slogan Toko</label>
           ...
           <div className="flex flex-col items-end gap-10">
              <div className="flex gap-20">
                <div className="space-y-6">
                   <p className="text-[10px] font-black uppercase tracking-[0.4em] text-[#A68966]">Halaman</p>
                   <ul className="space-y-4 font-black text-xs uppercase tracking-widest opacity-40">
                      <li className="hover:opacity-100 cursor-pointer" onClick={() => window.scrollTo({top:0, behavior:'smooth'})}>Beranda</li>
                      <li className="hover:opacity-100 cursor-pointer" onClick={() => {setIsCartOpen(true)}}>Keranjang</li>
                   </ul>
                </div>
              </div>
              <button onClick={() => setIsLoginModalOpen(true)} className="text-[10px] font-black opacity-20 uppercase tracking-[0.4em] hover:opacity-100 transition-opacity">Admin Panel Access</button>
           </div>
        </div>
        <div className="max-w-7xl mx-auto mt-40 pt-16 border-t border-gray-100 dark:border-white/5 text-[10px] font-black uppercase tracking-[0.4em] opacity-30 flex justify-between items-center">
           <p>© 2024 {profile.shopName}. Crafted In Indonesia.</p>
           <span>Heritage UMKM Edition</span>
        </div>
      </footer>
        ...
        <div className="fixed inset-0 z-[250] flex items-center justify-center p-4 bg-black/60 backdrop-blur-md">
          <div className={`${darkMode ? 'bg-[#2A2825] border-white/5' : 'bg-white border-[#E8E2D9]'} p-12 rounded-[3.5rem] w-full max-w-sm shadow-2xl border`}>
            <div className="text-center mb-10">
               ...
               <h2 className="text-3xl font-black tracking-tighter">Administrator</h2>
               <p className="text-[10px] font-black uppercase opacity-30 tracking-widest mt-2">Masuk Panel Kendali</p>
            </div>
            <div className="space-y-4">
              ...
              <button onClick={handleLogin} className="w-full bg-[#4A443F] text-white py-6 rounded-2xl font-black text-lg mt-6 hover:bg-black shadow-xl active:scale-95 transition-all">Buka Dashboard</button>
              <button onClick={() => setIsLoginModalOpen(false)} className="w-full text-xs font-black opacity-40 mt-4 uppercase tracking-widest text-center">Batal & Kembali</button>
            </div>
          </div>
        </div>
      )}
...
/**
 * --- DOKUMENTASI LENGKAP PENGGUNAAN SISTEM (CLEAN BUILD V4) ---
 * * 1. MENGATASI HALAMAN KOSONG:
 * - Jika Katalog atau Ulasan terlihat kosong, artinya data di Supabase Anda belum diisi.
 * - Website ini dinamis, jadi tampilannya tergantung pada apa yang Anda input di Dashboard Admin.
 * - Saya telah menambahkan "Empty State" (pesan jika data kosong) agar website tidak terlihat rusak.
 * * 2. AKSES ADMIN:
 * - Username: arunika | Password: arunika1234.
 * - Tombol masuk ada di bagian paling bawah (Footer) bertuliskan "Admin Panel Access".
 * * 3. FIX BUILD VERCEL (ESLINT):
 * - Ikon 'Filter' telah di-import dan digunakan di bagian 'Categories'.
 * - Semua variabel yang dipanggil (seperti saveProduct, handleDeleteProduct, dll) sudah dipastikan ada.
 * * 4. PENGATURAN SUPABASE:
 * - Pastikan Tabel: "products", "testimonials", dan "profile" sudah ada.
 * - Pastikan Bucket Storage: "product-images" diset ke PUBLIC.
 * * 5. FITUR STOK & SEARCH:
 * - Jika Stok diatur ke 0, produk akan otomatis berlabel "STOK HABIS".
 * - Pencarian berfungsi secara real-time berdasarkan nama produk.
 * * 6. HERO VISUAL:
 * - Menambahkan placeholder visual di bagian Hero agar website tidak terlalu banyak ruang putih kosong.
 */
